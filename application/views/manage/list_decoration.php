<form id="pagerForm" method="post" action="<?php echo site_url('manage/list_decoration')?>">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo site_url('manage/add_decoration')?>" target="dialog" rel="add_decoration" title="新建"><span>新建</span></a></li>
			<li><a class="delete" href="<?php echo site_url('manage/delete_decoration')?>/{id}" target="ajaxTodo"  title="确定要删除？" warn="请选择一条记录"><span>删除</span></a></li>
			<li><a class="edit" href="<?php echo site_url('manage/edit_decoration/{id}')?>" target="dialog" rel="edit_decoration" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
		</ul>
	</div>
