        ...
        <div class="pageFormContent" layoutH="55">
        	<fieldset>
        		...
        		<dl>
        			<dt>相关楼盘：</dt>
        			<dd>
	        			<input name="h_id" type="hidden" value="<?php if(!empty($h_id)) echo $h_id;?>" />
	        			<input type="text" name="h_name" value="<?php if(!empty($h_name)) echo $h_name;?>" readonly style="width: 280px;" >
