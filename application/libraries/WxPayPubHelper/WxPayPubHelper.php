...
*/
	//include_once(APPPATH."libraries/WxPayPubHelper/SDKRuntimeException.php");
	//include_once(APPPATH."libraries/WxPayPubHelper/WxPay.pub.config.php");
	include_once(dirname(__FILE__) . "/SDKRuntimeException.php");
	include_once(dirname(__FILE__) . "/WxPay.pub.config.php");
